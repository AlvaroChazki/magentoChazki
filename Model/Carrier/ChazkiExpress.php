 ...
 */
class ChazkiExpress extends AbstractCarrier implements CarrierInterface
{
    /**
     * @var string
     */
    protected $_code = 'chazkiargexpress';
     ...
     * @param ChazkiExpressFactory $chazkiRatesFactory
     * @param array $data
    ...
    public function __construct(
        ...
        ChazkiExpressFactory $chazkiRatesFactory,
        array $data = []
    ) {
...
//        }
    ...
    private function createShippingMethod($shippingPrice, $cost)
    {
        ...
        $method->setCarrierTitle($this->getConfigData('title') . ' (Leyenda Envio express)');
